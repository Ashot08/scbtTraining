...
class WPM_Page_Ordering {
	...
	public static function admin_head() {
		...
		$screen->add_help_tab(array(
			...
			'title' => __('Сортировка', 'mbl_admin'),
			'content' => '<p>' . __( 'Расположите материалы в нужной последовательности.', 'mbl_admin' ) . '</p>',
		));
	}
	...
	public static function sort_by_order_link( $views ) {
		...
		$views['byorder'] = sprintf('<a href="%s" class="%s">%s</a>', $query_string, $class, __('Сортировка', 'mbl_admin'));
