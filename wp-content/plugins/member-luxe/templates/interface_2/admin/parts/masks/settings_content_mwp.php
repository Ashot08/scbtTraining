    ...
    <div class="wpm-tab-content">
        ...
        <div class="row">
            <div class="col col-33">
				...
				<?php wpm_render_partial('options/color-row', 'admin', array('label' => __('Цвет текста:', 'mbl_admin'), 'key' => 'mbl_wp.block_0.color', 'main' => true)) ?>
            </div>
        ...
        <div class="row">
            <div class="col col-33">
				...
				<?php wpm_render_partial('options/color-row', 'admin', array('label' => __('Цвет текста:', 'mbl_admin'), 'key' => 'mbl_wp.block_1.color', 'main' => true)) ?>
            </div>
        ...
        <div class="row">
            <div class="col col-33">
				...
				<?php wpm_render_partial('options/color-row', 'admin', array('label' => __('Цвет текста:', 'mbl_admin'), 'key' => 'mbl_wp.block_2.color', 'main' => true)) ?>
            </div>
        ...
        <div class="row">
            <div class="col col-33">
				...
				<?php wpm_render_partial('options/color-row', 'admin', array('label' => __('Цвет текста:', 'mbl_admin'), 'key' => 'mbl_wp.block_3.color', 'main' => true)) ?>
            </div>
        ...
        <div class="row">
            <div class="col col-33">
				<?php wpm_render_partial('options/color-row', 'admin', array('label' => __('Цвет текста:', 'mbl_admin'), 'key' => 'mbl_wp.block_4.color', 'main' => true)) ?>
            </div>
            <div class="col col-33">
				<?php wpm_render_partial('options/color-row', 'admin', array('label' => __('Цвет фона:', 'mbl_admin'), 'key' => 'mbl_wp.block_4.background', 'main' => true)) ?>
            </div>
            <div class="col col-33">
				<?php wpm_render_partial('options/color-row', 'admin', array('label' => __('Цвет рамки:', 'mbl_admin'), 'key' => 'mbl_wp.block_4.border', 'main' => true)) ?>
            </div>
        </div>
