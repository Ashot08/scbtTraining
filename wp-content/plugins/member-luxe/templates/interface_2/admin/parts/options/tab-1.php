<div class="wpm-tab-content">
    <div class="wpm-inner-tabs" tab-id="h-tabs-1">
        ...
        <div id="mbl_inner_tab_1_8" class="wpm-tab-content">
            ...
            <div class="wpm-row">
                <label>
                    <input type="radio" name="main_options[subscribe][type]" value="subscribe_just_click" class="letter_options"  <?php echo ($main_options['auto_subscriptions']['justclick']['active'] == 'on') ? 'checked="checked"':''?>><?php _e('Автоподписка JustClick', 'mbl_admin') ?>
                </label>
                <div id="subscribe_just_click_api_key_label" class="letter_options_label <?php echo ($main_options['auto_subscriptions']['justclick']['active'] == 'on') ? '':'invisible'?>">
                    <div>
                        <p>
                            <label>
                                ...
                                <input type="checkbox"
                                    ...
                                    <?php echo ($main_options['auto_subscriptions']['justclick']['active'] == 'on') ? 'checked="checked"':''?>
                ...
                <br>
                <label>
                    <input type="radio" name="main_options[subscribe][type]" value="subscribe_send_pulse" class="letter_options" <?php echo ($main_options['auto_subscriptions']['sendpulse']['active'] == 'on') ? 'checked="checked"':''?>><?php _e('Автоподписка SendPulse', 'mbl_admin') ?>
                </label>
                <div id="subscribe_send_pulse_api_key_label" class="letter_options_label <?php echo ($main_options['auto_subscriptions']['sendpulse']['active'] == 'on') ? '':'invisible'?>"">
                <p>
                    <label>
                        <input type="checkbox"
                               name="main_options[auto_subscriptions][sendpulse][active]"
                               class="active_checkbox"
                            <?php echo ($main_options['auto_subscriptions']['sendpulse']['active'] == 'on') ? 'checked="checked"':''?>>
                        <?php _e('Включить', 'mbl_admin') ?></label>
                </p>
                <p>
                    <label>
            ...
            <br>
            <label>
                <input type="radio" name="main_options[subscribe][type]" value="subscribe_auto_web" class="letter_options" <?php echo ($main_options['auto_subscriptions']['autoweb']['active'] == 'on') ? 'checked="checked"':''?>><?php _e('Автоподписка АвтоВебОфис', 'mbl_admin') ?>
            </label>
            <div id="subscribe_auto_web_api_key_label" class="letter_options_label <?php echo ($main_options['auto_subscriptions']['autoweb']['active'] == 'on') ? '':'invisible'?>">
                <div>
                    <p>
                        <label>
                            <input type="checkbox"
                                   ...
                                   class="active_checkbox"
                                <?php echo ($main_options['auto_subscriptions']['autoweb']['active'] == 'on') ? 'checked="checked"':''?>>
                            <?php _e('Включить', 'mbl_admin') ?></label>
                    </p>
                    <p>
                        <label>
