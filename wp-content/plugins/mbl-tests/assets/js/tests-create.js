    ...
    <div class="mbl-test-editor">
      <ul class="mbl-test-question">
        ...
        <li v-for="(question, i) in questions" :key="i" :class="{active: question.isEdited}">
          ...
          <div v-show="!question.isEdited" v-html="question.text" class="question-text clearfix"></div>
...
Vue.component('answers-list', {
    ...
    <ul class="list">
      ...
      <div v-if="!answer.edit" v-html="answer.text" class="mbl-test-answer clearfix">
