...
class WC_Product_IPR extends WC_Product
{
    ...
    {
        $this->product_type = MBLPProduct::IPR_PRODUCT_TYPE;
        $this->virtual = 'yes';
    ...
    {
        return count($this->get_ipr_codes());
    }

    public function get_type()
    {
        return MBLPProduct::IPR_PRODUCT_TYPE;
    }
    ...
    public function get_ipr_codes($context = 'view')
    {
        return $this->get_prop('ipr_codes', $context);
    }

    public function get_ipr_codes_string($context = 'view')
    {
        $codes = $this->get_ipr_codes($context);
    ...
    public function set_ipr_codes($codes)
    {
        $this->set_prop('ipr_codes', $codes);
    }
