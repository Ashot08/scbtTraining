            ...
            if ( $order == 'header_search' ) { ?>
                <div class="header-search">
                    ...
                    if ( is_user_logged_in() ) {
                        global $rcl_user_URL;
                        echo '<a style="border-radius: 4px;top: -3px;position: relative;" class="recall-button" href="' . wp_logout_url( home_url() ) . '"><i class="rcl-bttn__ico rcl-bttn__ico-left rcli fa-sign-out"></i><span class="rcl-bttn__text">Выход</span></a>';
                    } else {
                        if(!is_front_page()){
                            echo '<a style="border-radius: 4px;top: -3px;position: relative;" href="#" class="recall-button rcl-login" ><i class="rcl-bttn__ico rcl-bttn__ico-left rcli fa-sign-in"></i><span class="rcl-bttn__text">Вход</span></a><br />';
                        }
